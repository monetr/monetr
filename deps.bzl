...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_ahmetb_go_linq_v3",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/ahmetb/go-linq/v3",
        sum = "h1:BEuMfp+b59io8g5wYzNoFe9pWPalRklhlhbiU3hYZDE=",
        version = "v3.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:hrqDB4cHFSHQf4gO3xu6YKQg8PqJpNjLYsQAFYHstqw=",
        version = "v2.30.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:9lR4a6MKQW/t6YCG0ZKAt1GAkjdEPP8sWch/pfcuR0c=",
        version = "v1.44.174",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:FLloufuC7NcbHqDzVQ42CG9AKryS1gAGCRt8nQRsW+Y=",
        version = "v6.20.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rWM60bPJpVcIZWgubYDvipTeHdJlseDM5hovR+wgFVo=",
        version = "v2.14.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_go_pg_migrations_v8",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/go-pg/migrations/v8",
        sum = "h1:bc1wQwFoWRKvLdluXCRFRkeaw9xDU4qJ63uCAagh66w=",
        version = "v8.1.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3bRjMiOo6N4zcRgZWV3Y7uX7R22SF+A9bPTk4xRXr34=",
        version = "v0.5.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BIKfiyELXV0A8SRCHQaByJW0s71xXpArhzfTS3uf26c=",
        version = "v1.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:hrIVmPevJY3ICS1Ob4yjqJToQiv2eD9iHaJBjxMihWY=",
        version = "v1.3.3",
    )
    ...
    go_repository(
        name = "com_github_nleeper_goment",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/nleeper/goment",
        sum = "h1:GlMTpxvhueljArSunzYjN9Ri4SOmpn0Vh2hg2z/IIl8=",
        version = "v1.4.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5UUI9hE79Kk0dymSquXbMYB7IlNDNhvu2aNlJpm9et8=",
        version = "v1.1.7",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_plaid_plaid_go_v14",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/plaid/plaid-go/v14",
        sum = "h1:HFZJXuNM1sCDFQneujq/u/HUngvMxtZhn7sPNo5Zadc=",
        version = "v14.0.0",
    )
    ...
    go_repository(
        name = "com_github_stripe_stripe_go_v72",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/stripe/stripe-go/v72",
        sum = "h1:eRXWqnEwGny6dneQ5BsxGzUCED5n180u8n665JHlut8=",
        version = "v72.122.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:yyZVHtQRVZ+wvlte5HXvSpBkR0dPYnPEIgq9qqAqltk=",
        version = "v0.2.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_xlzd_gotp",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/xlzd/gotp",
        sum = "h1:LZpKQbMSngtN4ycCtogkxYl5ec0FimAA8rSrI4ZMGTM=",
        version = "v0.0.0-20220110052318-fab697c03c2c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:0LPJPKamw3xsVpkel1bDtK0vVJec3EyqdQOLitiD030=",
        version = "v1.11.0",
    )
    go_repository(
    ...
    go_repository(
        name = "in_gopkg_ezzarghili_recaptcha_go_v4",
        build_file_proto_mode = "disable_global",
        importpath = "gopkg.in/ezzarghili/recaptcha-go.v4",
        sum = "h1:85T5ZYeVUgkfHBQqlMxlW1pzrBIta9K26ykU3N1vISs=",
        version = "v4.3.0",
    )
    go_repository(
