...
(
    ...
    CONSTRAINT "fk_spending_funding_schedules_funding_schedule_id_account_id_bank_account_id" FOREIGN KEY ("funding_schedule_id", "account_id", "bank_account_id") REFERENCES "funding_schedules" ("funding_schedule_id", "account_id", "bank_account_id")
);
