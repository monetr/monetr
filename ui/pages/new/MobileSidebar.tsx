...
export default function MobileSidebar(): JSX.Element {
  ...
  return (
    <div className='fixed z-50 w-screen h-screen top-0 left-0 lg:hidden dark:bg-dark-monetr-background flex flex-row backdrop-blur-sm dark:bg-opacity-50 backdrop-brightness-50'>
      <BankSidebar />
