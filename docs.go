...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "428": {
                        "description": "Precondition Required",
                        "schema": {
                            "$ref": "#/definitions/swag.LoginPreconditionRequiredResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/swag.VerifyRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/swag.VerifyResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/authentication/verify/resend": {
            "post": {
                "description": "This endpoint is used to generate a new verification token and email it to an address to verify that the\nemail address is owned by a user. This endpoint only works with addresses that are associated with a\nlogin, and will return a successful status code **if** the provided email is associated with a login and\nthe email is not already verified. All other situations will return a bad request, even if the email is\nvalid or if the email is not associated. This is to prevent someone from being able to have relatively\neasy access to an endpoint that would let them see what email addresses are associated with active users.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/swag.ResendVerificationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/sentry": {
            "get": {
                ...
                "operationId": "get-ui-sentry-dsn",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/swag.SentryDSNResponse"
                        }
                    }
                }
            }
        ...
        "/users/me": {
            "get": {
                ...
                "description": "Retrieve details about the currently authenticated user. If the user is not authenticated then an error\nwill be returned to the client. This is used by the UI to determine if the user is actually\nauthenticated. This is because cookies are stored as HTTP only, and are not visible by the JS code in\nthe UI.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/users/security/password": {
            "put": {
                ...
                "description": "Change the currently authenticated user's password. This requires that the current password be provided\nby the client to make sure that some actor other than the current user is not performing the action. If\nthe request succeeds and the password is changed, no JSON will be returned; just a 200 status code.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/swag.ChangePasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "swag.ChangePasswordRequest": {
            ...
            "properties": {
                "currentPassword": {
                    "description": "The current password for the authenticated user. This must be provided or the new password will not be accepted.",
                    "type": "string",
                    "minLength": 8,
                    "example": "I@mY0ur0ldP@ssw0rd"
                },
                "newPassword": {
                    "description": "The new password desired for the authenticated user. This must meet all the requirements",
                    "type": "string",
                    "minLength": 8,
                    "example": "I@mY0urN#wP@ssw0rd"
                }
            }
        },
        "swag.ConfigResponse": {
            ...
            "properties": {
                ...
                "verifyEmailAddress": {
                    "description": "Tells the API client that after a registration the client should handle not being authenticated. Instead, the\nuser would be prompted to verify their email address.",
                    "type": "boolean"
                },
                "verifyLogin": {
        ...
        "swag.HealthResponse": {
            ...
            "properties": {
                ...
                "revision": {
                    ...
                    "type": "string",
                    "example": "c1becbe0654c4d8fde74c349ef7596983361eb7c"
                },
                "serverTime": {
        ...
        "swag.LoginPreconditionRequiredResponse": {
            ...
            "properties": {
                ...
                "error": {
                    "description": "Error will contain a generic message about the problem.",
                    "type": "string",
        ...
        "swag.LoginRequest": {
            ...
            "properties": {
                ...
                "totp": {
                    "description": "TOTP is used to provide an MFA code for the login process. It is not required to provide this code. If a login has\nTOTP enabled then the request will fail and should be resubmitted with the TOTP code provided.",
                    "type": "string",
                    "x-nullable": true,
                    "example": "123456"
                }
        ...
        "swag.MeResponse": {
            ...
            "properties": {
                "hasSubscription": {
                    "description": "HasSubscription is another billing indicator, this field is only present on the response when the server does\nhave billing enabled. It indicates whether or not the user does have a subscription, but not whether that\nsubscription is active. This can be true even if the subscription has expired.",
                    "type": "boolean",
                    "x-nullable": true
                },
                "isActive": {
                    "description": "IsActive is an indicator of whether or not a user's subscription is active. This field is always present and is\ntrue if billing is not configured on the instance at all. It is only ever false if the server has billing\nconfigured _and_ the user's subscription has expired or has never been set up.",
                    "type": "boolean"
                },
                "isSetup": {
                    "description": "IsSetup indicates whether or not the user has any links configured at all. If this is false then the user should\nbe prompted to set up a new link.",
                    "type": "boolean"
                },
                "nextUrl": {
                    "description": "NextURL is only present when the user needs to be directed somewhere by the backend. Currently, it is leveraged\nfor billing purposes. But in the future it can be used to direct the user through an on-boarding flow or\nsomething similar.",
                    "type": "string",
                    "x-nullable": true
                },
                "user": {
                    "description": "User has all of the details about the currently authenticated user.",
        ...
        "swag.RegisterResponse": {
            ...
            "properties": {
                "message": {
                    "description": "Message is included if the register endpoint needs to display something to the end user. Currently this is used\nto return a message to the user indicating that we have sent them an email to verify they own the provided email\naddress. This field is not always present.",
                    "type": "string",
                    "x-nullable": true,
                    "example": "A verification email has been sent to your email address, please verify your email."
                },
                "nextUrl": {
        ...
        "swag.ResendVerificationRequest": {
            "type": "object",
            "properties": {
                "captcha": {
                    "description": "ReCAPTCHA value from validation. Required if ` + "`" + `verifyResend` + "`" + ` is enabled on the server. This is used to prevent\nthis endpoint from easily being spammed.",
                    "type": "string",
                    "x-nullable": true,
                    "example": "03AGdBq266UHyZ62gfKGJozRNQz17oIhSlj9S9S..."
                },
        ...
        "swag.SentryDSNResponse": {
            "type": "object",
            "properties": {
                "dsn": {
                    "description": "Public Sentry DSN for monetr. This is to be used by the UI to provide some basic error reporting.",
                    "type": "string"
                }
            }
        },
        ...
        "swag.VerifyRequest": {
            ...
            "properties": {
                "token": {
                    "description": "A token string extracted from the URL param ` + "`" + `?token=` + "`" + ` from the email verification link that is sent to user's to\nmake sure that they own or at least have access to their email.",
                    "type": "string",
                    "example": "eyJhbGciOiJIUzI1NiIs..."
                }
            }
        ...
        "swag.VerifyResponse": {
            ...
            "properties": {
                "message": {
                    "description": "Message is used to display a toast to the user upon responding to this API call. Right now this represents a\nsuccessful message and tells the user they are good to go. But in the future this message could articulate\nanything to the user.",
                    "type": "string",
                    "example": "Your email is now verified. Please login."
                },
                "nextUrl": {
                    "description": "Is used by the UI to direct the user at the end of the verification request. If the verification request is\nsuccessful (meaning the user's email address is now verified) then this will usually be ` + "`" + `/login` + "`" + ` to prompt the\nuser to now login using their credentials.",
                    "type": "string",
                    "example": "/login"
                }
            }
    ...
    "tags": [
        {
            "description": "Authentication endpoints for end users.",
            "name": "Authentication"
        },
        {
            "name": "Bank Accounts"
