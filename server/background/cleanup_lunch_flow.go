...
const (
	// CleanupLunchFlowName is a job that runs nightly and just removes any Lunch
	// Flow links that are in a pending status. These serve no purpose and are
	...
	CleanupLunchFlowName = "CleanupLunchFlow"
)
