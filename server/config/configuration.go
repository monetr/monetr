...
func setupDefaults(v *viper.Viper) {
	...
	v.SetDefault("KeyManagement.OpenBao", nil)
...
func setupEnv(v *viper.Viper) {
	...
	_ = v.BindEnv("KeyManagement.OpenBao.AuthMethod", "MONETR_OPENBAO_AUTH_METHOD")
	_ = v.BindEnv("KeyManagement.OpenBao.Token", "MONETR_OPENBAO_TOKEN")
	_ = v.BindEnv("KeyManagement.OpenBao.Endpoint", "MONETR_OPENBAO_ENDPOINT")
