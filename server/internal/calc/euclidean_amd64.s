...
// func __euclideanDistanceAVX(a, b []float64) float64
TEXT ·__euclideanDistanceAVX(SB), NOSPLIT, $0-48
  ; MOVQ len+0(SP), CX
  ...
  LOOP:
    ...
    VMULPD Y1, Y1 ,Y1   // Square the result and overwrite the buffer TODO: does that even work, might need to overwrite Y2 instead
  ...
  MOVQ X0, CX        // Pluck the lower 64 bits out of the X0 register
  MOVQ CX, ret+48(FP) // Move the 10 into the return address space
  RET                   // Return
