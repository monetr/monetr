...
//
//	mockgen -source=platypus.go -package=mockgen -destination=../internal/mockgen/platypus.go Platypus
//
...
import (
	...
	plaid "github.com/plaid/plaid-go/v43/plaid"
...
func (mr *MockPlatypusMockRecorder) CreateLinkToken(ctx, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPlatypusMockRecorder) ExchangePublicToken(ctx, publicToken any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPlatypusMockRecorder) GetInstitution(ctx, institutionId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPlatypusMockRecorder) GetWebhookVerificationKey(ctx, keyId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPlatypusMockRecorder) NewClient(ctx, link, accessToken, itemId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPlatypusMockRecorder) NewClientFromItemId(ctx, itemId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockPlatypus) NewClientFromLink(ctx context.Context, accountId models.ID[models.Account], linkId models.ID[models.Link]) (platypus.Client, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPlatypusMockRecorder) NewClientFromLink(ctx, accountId, linkId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
