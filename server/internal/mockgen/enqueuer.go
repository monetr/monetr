...
func (m *MockJobEnqueuer) EnqueueJob(ctx context.Context, queue string, data interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockJobEnqueuerMockRecorder) EnqueueJob(ctx, queue, data interface{}) *gomock.Call {
