import { Divider, LinearProgress, List, ListItem, ListItemIcon, Typography } from '@material-ui/core';
...
export class ExpenseDetail extends Component<WithConnectionPropTypes, {}> {
