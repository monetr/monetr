...
:::info
monetr does not support TLS for this cache server at this time. Sensitive information is never cached on this server and
the use of the cache is purely for performance.
:::
