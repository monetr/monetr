...
![Plaid Link Customization Screen](/v1/en/documentation/configure/assets/plaid_link_customization.png)
...
![Plaid Link Customization Settings Dialog](/v1/en/documentation/configure/assets/plaid_link_customization_settings_dialog.png)

## Webhooks

For what monetr does with each webhook Plaid sends, and how the request is verified, see
[Webhooks](/documentation/api/webhooks#plaid-webhook).
