...
```ini title="$HOME/.monetr/development.env"
PLAID_CLIENT_ID=...
PLAID_CLIENT_SECRET=...
```
...
![Stripe Test Mode](/v1/en/documentation/development/assets/stripe_test_mode.png)

You will need to click `Reveal test key` in order to retrieve the API key.

![Stripe Keys](/v1/en/documentation/development/assets/stripe_keys.png)

### Webhook secret

On the [Stripe Webhooks](https://dashboard.stripe.com/test/webhooks) page click `+ Add endpoint`.

![New Stripe Webhook](/v1/en/documentation/development/assets/stripe_new_webhook.png)
...
![Stripe Created Webhook](/v1/en/documentation/development/assets/stripe_created_webhook.png)
