...
import { ShoppingCart, Link2, Package } from 'lucide-react';
...
![Transaction Upload Modal](/v1/en/documentation/use/transactions/assets/transaction_upload_modal.png)
...
![Transaction Upload with file selected](/v1/en/documentation/use/transactions/assets/transaction_upload_file.png)
...
![Transaction Upload Completed](/v1/en/documentation/use/transactions/assets/transaction_upload_complete.png)
...
![Transaction Upload Done, transactions and balances updated](/v1/en/documentation/use/transactions/assets/transaction_upload_final.png)
...
<Cards.Card
  icon={<Package />}
  title="Configure storage for file uploads."
  description="Configure storage for file uploads."
  href="/documentation/configure/storage"
/>

## Doing this over the API

Files can be uploaded and their import progress watched over the REST API. See
[Uploads and Files API](/documentation/api/uploads).
