...
![Security Settings Screenshot](/v1/en/documentation/use/security/assets/security_settings.png)
...
configured and forgot password enabled. There is an issue to track the feature of allowing passwords to be reset via the
monetr CLI for self hosted instances: <GithubIssue prefix='feature' issueNumber={ 1969 } />
:::
