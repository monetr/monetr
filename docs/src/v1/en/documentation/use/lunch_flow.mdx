...
:::warning
**Note**: Lunch Flow is only supported for **self-hosted** instances of monetr, and is not available on the hosted
version.
:::


:::info
**Note**: The Lunch Flow integration is currently considered a **"beta"** integration. There may be bugs and issues with
the data connection that lead to unexpected or undesired behaviors. Please report any bugs you have to monetr, though
...
![Sign up for Lunch Flow](/v1/en/documentation/use/assets/lunch_flow_signup.png)

### Verify your Email Address

Once you have signed up you will probably need to verify your email address, do this now in order to proceed.

![Verify your email address](/v1/en/documentation/use/assets/lunch_flow_verify_email.png)

You'll receive an email from Lunch Flow that looks like this:

![Email from Lunch Flow](/v1/en/documentation/use/assets/lunch_flow_verify_email_gmail.png)
...
![Lunch Flow dashboard](/v1/en/documentation/use/assets/lunch_flow_landing.png)

You'll be prompted to select a plan in order to begin your trial:

![Lunch Flow Plan Selection](/v1/en/documentation/use/assets/lunch_flow_trial_start.png)
...
![Lunch Flow After Trial](/v1/en/documentation/use/assets/lunch_flow_after_subscribe.png)

Once you are on the connections page, you can click **New Connection** at the top of the screen to begin the setup with
your institution.

![Lunch Flow no connections](/v1/en/documentation/use/assets/lunch_flow_connections_page_empty.png)

Select the provider based on the region your financial institution is in.

![Lunch Flow add connection](/v1/en/documentation/use/assets/lunch_flow_add_connection.png)
...
![Lunch Flow with connections](/v1/en/documentation/use/assets/lunch_flow_connections.png)
...
![Lunch Flow no destinations](/v1/en/documentation/use/assets/lunch_flow_destinations_empty.png)

Click **Add your first destination** to proceed.

![Lunch Flow add destination](/v1/en/documentation/use/assets/lunch_flow_add_destination.png)

In the Add Destination modal, you'll need to select the **REST API** destination for monetr.

![Lunch Flow API destination](/v1/en/documentation/use/assets/lunch_flow_api_destination.png)
...
![Lunch Flow destinations](/v1/en/documentation/use/assets/lunch_flow_destinations.png)
...
![Lunch Flow connection details](/v1/en/documentation/use/assets/lunch_flow_connection_details.png)

From here you can **copy** the API Key that you will need for monetr later on.

:::warning
**Note**: This API Key is sensitive and should be handled carefully. Do not store the API Key in plain text. Store it
in a password manager or somewhere secure. The API Key is read-only, however it does still allow access to sensitive
...
![monetr setup with Lunch Flow](/v1/en/documentation/use/assets/monetr_setup_with_lunch_flow.png)

Select **Lunch Flow** and click **Continue**.

![monetr Lunch Flow intro](/v1/en/documentation/use/assets/monetr_lunch_flow_intro.png)
...
![monetr Lunch Flow account selection](/v1/en/documentation/use/assets/monetr_lunch_flow_account_selection.png)
...
![monetr Lunch Flow complete](/v1/en/documentation/use/assets/monetr_lunch_flow_complete.png)
...
![monetr Lunch Flow final](/v1/en/documentation/use/assets/monetr_lunch_flow_account.png)

</Steps>

## Syncing

monetr will fetch data from Lunch Flow's API every 12 hours. The exact cron schedule that monetr uses is `30 */12 * *
*`. In the future this will be configurable and will support triggering a sync manually.
...
Lunch Flow connections can be set up and synced over the REST API. See the
[Lunch Flow API](/documentation/api/lunch_flow).
