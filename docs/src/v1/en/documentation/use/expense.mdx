...
![Expenses Empty View](/v1/en/documentation/use/assets/expense_empty.png)

Then, click **New Expense** in the top navigation to open the creation modal.

![New Expense Modal](/v1/en/documentation/use/assets/expense_new_modal.png)
...
![Expenses View Simple](/v1/en/documentation/use/assets/expense_view_simple.png)
...
![Expense Details Example](/v1/en/documentation/use/assets/expense_rent_details.png)
...
![Expense Timeline Example](/v1/en/documentation/use/assets/expense_rent_timeline.png)

## Doing this over the API

Expenses can be created and managed over the REST API. See the
[Spending API](/documentation/api/spending).
