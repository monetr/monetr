...
![Funding Schedules Empty View](/v1/en/documentation/use/assets/funding_empty_view.png)

Then, click **New Funding Schedule** in the top navigation to open the creation modal.

![New Funding Modal](/v1/en/documentation/use/assets/funding_new_modal.png)
...
![Funding Schedule Details](/v1/en/documentation/use/assets/funding_details.png)
...
:::info
Holidays are not yet accounted for, but this feature will be added in the future, particularly for bank holidays that
impact deposits.
:::
...
![Estimated Contribution](/v1/en/documentation/use/assets/funding_estimate_example.png)
...
![Funding Timeline Example](/v1/en/documentation/use/assets/funding_timeline.png)
...
Funding schedules can be created and edited over the REST API. See
[Funding Schedules API](/documentation/api/funding_schedules), and
[Recurrence Rules](/documentation/api/recurrence_rules) for how to express the frequencies
above as rules the API accepts.
