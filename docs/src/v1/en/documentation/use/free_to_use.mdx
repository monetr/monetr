...
![Free to use screenshot](/v1/en/documentation/use/assets/free_to_use.png)
...
![Negative free to use screenshot](/v1/en/documentation/use/assets/negative_free_to_use.png)
...
:::warning
**Note**: This process only changes how funds are allocated within monetr. It does not move actual money in your bank
account.
:::
...
![Expense details showing the transfer button](/v1/en/documentation/use/assets/transfer_expense_details.png)
...
![Transfer modal screenshot](/v1/en/documentation/use/assets/transfer_modal.png)
...
![Transfer complete screenshot](/v1/en/documentation/use/assets/transfer_complete.png)
...
![Transfer modal focused screenshot](/v1/en/documentation/use/assets/transfer_modal_focused.png)
