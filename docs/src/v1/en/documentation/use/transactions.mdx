...
![Transaction Spent From Menu](/v1/en/documentation/use/assets/transaction_spent_from_menu.png)
...
![Transactions View Mobile](/v1/en/documentation/use/assets/transactions_view_mobile.png)

{<h3>Open the <b>Spent From</b> Dropdown</h3>}

On the transaction details page, tap on the **Spent From** dropdown.

![Transaction Details Mobile](/v1/en/documentation/use/assets/transaction_details_mobile.png)

{<h3>Choose the Budget</h3>}

Select the budget (Expense or Goal) that the transaction should be assigned to.

![Transaction Spent From Mobile](/v1/en/documentation/use/assets/transaction_mobile_spent_from_menu.png)
...
![Similar Transactions Example](/v1/en/documentation/use/assets/similar_transactions_example.png)
...
Everything on this page is available over the REST API. See the
[Transactions API](/documentation/api/transactions) for listing transactions, changing which
envelope one is spent from, and adding transactions by hand.
