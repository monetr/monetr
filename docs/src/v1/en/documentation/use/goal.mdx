...
:::info
**Need to manage recurring payments?** If you're tracking regular expenses like rent, subscriptions, or utility bills,
monetr's [Expenses](./expense) feature is designed for that purpose. Expenses are ideal for consistent obligations that
...
This approach avoids over-funding and ensures contributions align with the goal’s timeline.
...
target, while avoiding the risk of over-funding.

## Creating a Goal

To create a goal, navigate to the **Goals** section in the sidebar of your current account.

![Goals empty view](/v1/en/documentation/use/assets/goals_empty_view.png)

Then, click **New Goal** in the top navigation to open the creation modal.

![Create Goal modal](/v1/en/documentation/use/assets/goals_new_modal.png)
...
![Goals view with vacation item](/v1/en/documentation/use/assets/goals_view_simple.png)
...
![Goal details](/v1/en/documentation/use/assets/goal_details.png)
...
![Goal timeline](/v1/en/documentation/use/assets/goal_timeline.png)

## Doing this over the API

Goals can be created and managed over the REST API. See the
[Spending API](/documentation/api/spending), where goals and expenses share one endpoint.
