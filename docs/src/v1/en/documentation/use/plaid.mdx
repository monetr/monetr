...
monetr currently supports the following countries via Plaid:

- Canada
- United States

We are looking to add support for more countries in the future as we are capable. If you are self hosting monetr you can
configure additional countries via [Plaid Configuration](/documentation/configure/plaid).
...
![Healthy institution](/v1/en/documentation/use/assets/institution_healthy.png)

### Updates Stopped

If updates stop due to an issue with the bank or Plaid, the institution's logo will appear in black and white:

![Institution updates stopped](/v1/en/documentation/use/assets/institution_stopped.png)
...
![Bank dropdown menu](/v1/en/documentation/use/assets/plaid_bank_menu.png)

### Step 2: Select **Update Account Selection**
Choose **Update Account Selection** to open the Plaid interface.

![Plaid update account selection](/v1/en/documentation/use/assets/plaid_update_accounts.png)

### Step 3: Add New Accounts
Select the new accounts you want to connect and click **Continue**.

![Plaid update complete](/v1/en/documentation/use/assets/plaid_update_complete.png)
...
![Plaid removing access to an account](/v1/en/documentation/use/assets/plaid_remove_access.png)
...
![Remove Plaid link confirmation modal](/v1/en/documentation/use/assets/remove_plaid_link.png)
