...
The same projections are available over the REST API, including a what-if calculator for an
expense you haven't created yet. See the [Forecast API](/documentation/api/forecast).
