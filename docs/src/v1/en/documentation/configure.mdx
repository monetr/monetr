...
import { Coins, Server, Database, Shield, Link, ClipboardList, Link2, Lock, Send, Network, AlertTriangle, Terminal, Mail, Folder, Gauge } from 'lucide-react';
...
proofOfWork: { ... }   # Anti-Bot, proof of work configuration
...
<Cards.Card
  icon={<Coins />}
  title="Lunch Flow"
  description="Enable Lunch Flow connections as a data source."
  href="/documentation/configure/lunch_flow"
/>
<Cards.Card
  icon={<Link2 />}
  title="Plaid"
...
<Cards.Card
  icon={<Gauge />}
  title="Proof of Work"
  description="Require a background proof of work on the authentication endpoints to make automated abuse expensive."
  href="/documentation/configure/proof_of_work"
/>
<Cards.Card
  icon={<Shield />}
  title="ReCAPTCHA"
