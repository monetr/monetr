...
<Callout>
  This blog post contains information that is misunderstood and probably **wrong**, do not mistake this blog post and
  the achievement of the desired results as proof that I know what I'm doing. I am simply making mistakes in public so
  that people can point them out sooner.
</Callout>
...
This entire process is very much "good enough"[^2], my goal was to build something that provided similar transactions in a
...
[^1]: I perform this normalization only with the understanding (or assumed understanding) that it benefits the quality
      ...
      not actually be correct. However it is "good enough"[^2].
[^2]: This has not been certified as good enough by the [certified good enough certification
