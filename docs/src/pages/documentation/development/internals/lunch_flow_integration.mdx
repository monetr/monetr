...
**Note**: The lunch flow sync API does not take a lunch flow link ID. Instead it takes a regular link ID that must be a
lunch flow link type. This signature is the same used for the plaid sync API.
