...
1. Start by creating a Plaid account at: [Plaid Signup](https://dashboard.plaid.com/signup)
...
Teller credentials are not required for local development at this time.

If you are working with Teller it is recommended to set your environment to Sandbox via the `CMakeUserPresets.json` file
in your project directory.

**TODO**

[![GitHub issue/pull request detail](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.github.com%2Frepos%2Fmonetr%2Fmonetr%2Fissues%2F1666&query=%24.title&logo=github&label=docs)](https://github.com/monetr/monetr/issues/1666)
