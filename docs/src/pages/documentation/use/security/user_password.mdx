...
<div className='mt-8 pointer-events-none select-none w-full mb-[-15%]'>
    <div className="w-[125%] h-[125%] scale-75 origin-top-left aspect-video-vertical lg:aspect-video">
        <MonetrWrapper initialRoute='/settings/security'>
            <Monetr />
        </MonetrWrapper>
    </div>
</div>
