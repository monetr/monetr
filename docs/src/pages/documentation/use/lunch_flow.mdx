...
<sub>**Note**: The price or trial length may change in the future, if these docs are not represenative of the setup
...
Lunch Flow should be enabled by default for all self-hosted instances of monetr, but just incase you don't see it as an
