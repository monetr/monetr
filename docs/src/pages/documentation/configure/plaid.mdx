...
countries outside the US. For self-hosted environments you will need to contact Plaid support in order to have addtional
countries enabled for your account. EU based countries as well as the UK has special requirements and it may not be
possible to connect to them via Plaid given those requirements.
...
![Plaid Link Customiztion Screen](./assets/plaid_link_customization.png)
