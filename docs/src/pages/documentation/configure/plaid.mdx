...
| ---               | ---      | ---         | ---                                                                                                                                                                                                                               |
| `enabled`         | Boolean  | `true`      | Are users allowed to create Plaid links on this server? Even if this value is false, it is only considered enabled if the Client ID and Client Secret are also provided.                                                          |
