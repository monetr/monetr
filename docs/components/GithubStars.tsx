    ...
    <Link href='https://github.com/monetr/monetr' rel='noreferrer' target='_blank'>
      <div className={styles.root}>
        <div className={styles.iconWrap}>
          <svg className={styles.icon} fill='currentColor' role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
            <title>GitHub</title>
        ...
        <div className={styles.count}>
          {isLoading || !stars ? <span className={styles.skeleton}>???</span> : <span>{stars}</span>}
        </div>
      </div>
    </Link>
  );
