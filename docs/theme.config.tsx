...
const config: DocsThemeConfig = {
  ...
  chat: {
    ...
    icon: (
      <svg className='hidden sm:block' fill='currentColor' height='28' viewBox='0 0 16 16' width='28' xmlns='http://www.w3.org/2000/svg'>
    ...
    content: (
      <div className='flex w-full items-center sm:items-start justify-between md:px-20'>
        ...
        <div className='gap-2 sm:gap-4 flex flex-col sm:flex-row'>
          <a className='hover:underline text-sm' href='https://status.monetr.app/' target='_blank'>
            Status
          </a>
          <a className='hover:underline text-sm' href='/contact'>
            Contact
          </a>
          <a className='hover:underline text-sm' href='/policy/terms'>
            Terms & Conditions
          </a>
          <a className='hover:underline text-sm' href='/policy/privacy'>
            Privacy
          </a>
        </div>
      </div>
