...
type ChangePasswordRequest struct {
	// The current password for the authenticated user. This must be provided or the new password will not be accepted.
	CurrentPassword string `json:"currentPassword" validate:"required" minLength:"8" example:"I@mY0ur0ldP@ssw0rd"`
	// The new password desired for the authenticated user. This must meet all the requirements
	NewPassword string `json:"newPassword" validate:"required" minLength:"8" example:"I@mY0urN#wP@ssw0rd"`
}
