...
export default function PlaidLogo(props: PlaidLogoProps): JSX.Element {
  const className = mergeTailwind('w-28', props.className);
  return (
    <div>
