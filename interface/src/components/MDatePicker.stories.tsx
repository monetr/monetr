    ...
    <MForm initialValues={{}} onSubmit={() => {}}>
      <div className='w-full flex p-4'>
        <div className='w-full max-w-xl grid grid-cols-1 grid-flow-row gap-1'>
          ...
          />
          <MDatePicker label='When do you get paid next?' placeholder='Please select a date...' enableClear={true} />
          <MDatePicker
            ...
            enableClear={true}
          />
          <MDatePicker label='Must be in the future.' placeholder='Please select a date...' min={startOfTomorrow()} />
          <MDatePicker label='Go by year' placeholder='Please select a date...' enableYearNavigation />
          <MDatePicker label='Required date picker' placeholder='You must select a date...' required />
          <MDatePicker
            ...
            disabled
          />
          <MDatePicker label='With an error!' placeholder='Please select a date...' error='Invalid date selected!' />
        </div>
      </div>
    </MForm>
  ),
