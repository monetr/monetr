...
import { BrowserTransportOptions } from '@sentry/browser/build/npm/types/transports/types';
 ...
 * @returns `Transport`
 */
export function makeSneakyFetchTransport(
  options: BrowserTransportOptions,
  nativeFetch?: nativeFetchType,
): Transport {
