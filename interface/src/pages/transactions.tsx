...
function AddTransactionButton(): JSX.Element {
  ...
  return (
    <button 
      className='fixed bottom-4 right-4 w-14 h-14 rounded-full bg-dark-monetr-background backdrop-blur-sm bg-opacity-75 backdrop-brightness-200 z-20 flex items-center justify-center active:backdrop-brightness-50'
