...
![Trial has ended screenshot](./public/trial_ended.png)
...
![Stripe hosted subscription page](./public/billing_subscribe.png)
...
![Billing settings page](./public/billing_settings.png)

The Stripe hosted billing management page:

![Billing management page in Stripe](./public/billing_manage.png)
...
![Billing cancel page in Stripe](./public/billing_cancel.png)
